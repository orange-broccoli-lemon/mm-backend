        ...
        try:
            ...
            for row in rows:
                ...
                feed_comment = FeedComment(
                    ...
                    movie_release_date=str(row.movie_release_date) if row.movie_release_date else None
                )
    ...
    async def get_trending_feed(
        ...
        try:
            ...
            query = select(
                ...
                desc(func.count(CommentLikeModel.comment_id)),
                desc(CommentModel.created_at)
